    ...
    <div class="d-flex justify-content-center">
      <div class="card border-secondary mb-3" style="max-width: 100%;width: 70%;">
        <div class="card-body text-secondary">
          <h3>You Have to Change Your Passowrd.</h3>
          <h2
            style="color: black"
          >We Will send a mail to your mail address and you have to click on Change Passowrd link in your mail</h2>
          <hr>
        </div>
        <div class="card-text">
          <div class="d-flex justify-content-center">
...
module.exports = {
  ...
  methods: {
    ...
    sendMail() {
      ...
      Alert.Loader();
      this.$http.post("/user/changepassword", data).then(
        function(response) {
          toastr.success(response.data.msg, "Successfuly", {
            timeOut: 5000,
            closeButton: true
          });
          this.msg = "Please check your mail and click on change password link";
          this.signout();
          Alert.StopLoader();
          router.push("/");
        },
